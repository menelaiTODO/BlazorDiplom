        ...
        public async Task RunAsync()
        {
            ...
            await Task.Run(() =>
            {
                ...
                try
                {
                    ...
                    var dwhDates = factSalesDWH.Select(item => new DimDate { OrderDate = item.OrderDate, Day = (int)item.OrderDate.Day, Year = item.OrderDate.Year, Month = item.OrderDate.Month, MonthName = item.OrderDate.ToString("MMMM") }).Distinct();
